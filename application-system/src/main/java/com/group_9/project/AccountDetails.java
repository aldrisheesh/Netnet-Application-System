...
import com.group_9.project.RoundedComponents.RoundedPasswordField;
import com.group_9.project.RoundedComponents.RoundedTextField;

public class AccountDetails extends Template {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new AccountDetails().setVisible(true));
    }
}